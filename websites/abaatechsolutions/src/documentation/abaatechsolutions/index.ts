...
const SwaggerDoc = (app: Express, port: number) => {
  app.use(`/v${version}/abaatechsolutions/docs`, swaggerUI.serve, swaggerUI.setup(Object.assign(swaggerSpec,{"paths":Object.assign(
    LoginDocucment,
  ...
  console.log(`http://localhost:${port}/v${version}/ http://localhost:${port}/v${version}/abaatechsolutions/docs customer micro-service `);
}
